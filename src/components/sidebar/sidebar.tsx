      ...
      {user && (
        <>
          ...
          <nav>
            ...
            <Link to="/expenses" className={location.pathname === "/expenses" ? styles.active : ""}>💰 Gastos</Link>
            <Link to="/budgets" className={location.pathname === "/budgets" ? styles.active : ""}>📉 Presupuestos</Link>
